...
classes = []
tavlista = []
with open("E:\\szakdoga\\classes.txt", "r") as f:
    classes = f.read().splitlines()

cap = cv2.VideoCapture('E:\\szakdoga\\egy.mp4')
    ...
    for output in layerOutputs:
        for detection in output:
            ...
            if confidence > 0.2:
                ...
                kozeppont.append([x,y])
                gorbedata.append((x,600-y,tavolsag))
            if kozeppont:
                for i in kozeppont:
